<script lang="ts">
  ...
  <div class="flex absolute z-10 items-center left-0 lg:right-0 top-14 space-x-8 py-1 px-8 bg-brand-light rounded w-[20em] lg:w-max">
      ...
      <div class="flex flex-col justify-center items-end space-x-2">
        <button 
          class="hover:bg-white/25 py-2 px-4 text-white rounded" 
          on:click={() => {
